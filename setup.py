...
def install(pkg):
    print('\n[\x1b[92m!\x1b[37m] Installing ' + pkg + '...\n')
    os.system('pkg install ' + pkg + ' -y')

def install_Ngrok():
    print('\n[\x1b[92m!\x1b[37m] Installing Ngrok')
    if os.path.exists(binPath + 'ngrok'):
        time.sleep(1)
        print('\n[\x1b[92m!\x1b[37m] Ngrok is already Installed')
        return
    ...
    if not os.path.exists(file):
        print('\n[\x1b[91m!\x1b[37m] Ngrok install Error')
    ...
    file.close()
    print('\n[\x1b[92m!\x1b[37m] Ngrok install Complete')

def install_Cloudflared():
    print('\n[\x1b[92m!\x1b[37m] Installing Cloudflared')
    if os.path.exists(binPath + 'cloudflared'):
        time.sleep(1)
        print('\n[\x1b[92m!\x1b[37m] Cloudflared is Installed\n')
        return
    if uname == 'arm' or uname == 'Android':
    ...
    if not os.path.exists(file):
        print('\n[\x1b[91m!\x1b[37m] Claudflared install Error')
        print('[*] Install Manually')
        return
    os.system('mv -f ' + file + ' ' + binPath + 'cloudflared > /dev/null 2>&1')
    os.system('chmod +x ' + binPath + 'cloudflared')
    print('\n\x1b[92m!\x1b[37m] Cloudflared Install Complete')

def install_Setup():
    print('\n[\x1b[92m!\x1b[37m] Update and Upgrading...\n')
...
print('\n[\x1b[92m*\x1b[37m] Please Stand By')
print('\n[*] Installing Packages')
time.sleep(1)
install_Setup()
install_Ngrok()
time.sleep(0.5)
install_Cloudflared()
print('\n[\x1b[93m!\x1b[37m] Installation Complete!\n')